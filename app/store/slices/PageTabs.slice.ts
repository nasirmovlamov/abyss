...
const initialState: PageTabsState = {
  page_tabs: {
    ...
    productTabs: [
      { tabName: 'Code', link: 'codeCont', id: 2, isActive: false },
      { tabName: 'Info', link: 'requirementsCont', id: 3, isActive: true },
      { tabName: 'Forum', link: 'forumCont', id: 4, isActive: false },
      { tabName: 'Clips', link: 'clipCont', id: 5, isActive: false },
    ],
  },
}
...
export const { changeForumTabActive, changeProductTabActive, changeProductTabActiveWithoutScroll } =
