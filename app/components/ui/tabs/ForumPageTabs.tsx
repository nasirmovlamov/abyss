import * as PAGE_STY from '../../../styles/ui/modules/PageTabs.style'
      ...
      <PAGE_STY.Tabs_STY>
        <PAGE_STY.TabButtonsCont_STY>
          <PAGE_STY.TabButton_STY
            ...
            id="tab1"
            tabFocus={forumType.includes(searchTypes[0])}
            name="tab"
          >
          ...
          <PAGE_STY.TabButton_STY
            ...
            id="tab2"
            tabFocus={forumType.includes(searchTypes[1])}
            name="tab"
          >
          ...
          <PAGE_STY.TabButton_STY
            ...
            id="tab3"
            tabFocus={forumType.includes(searchTypes[2])}
            name="tab"
          >
      ...
      <PAGE_STY.TabTagsAndResults_STY>
        ...
        <PAGE_STY.TabTagsCont_STY>
          <PAGE_STY.TabTags_STY
            name="tag"
            tagFocus={forumSort.includes(searchSorts[0])}
          ...
          <PAGE_STY.TabTags_STY
            name="tag"
            tagFocus={forumSort.includes(searchSorts[1])}
          ...
          <PAGE_STY.TabTags_STY
            name="tag"
            tagFocus={forumSort.includes(searchSorts[2])}
