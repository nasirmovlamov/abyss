...
import { BlurredEditor, DetailsCont_STY } from '../../../styles/styled-components/ui/modules/CreateQuestionModal.style';
    ...
    <>
      ...
      {activeStoreTab.id !== 2 && (
        <DetailsCont_STY key={'details2'}>
          <LabelCont
            id={storeTabs[1].tabName}
            key={JSON.parse(singleProductData.data.description).details_data.sections_product[0].id}
          >
          ...
          <LabelCont
            key={JSON.parse(singleProductData.data.description).details_data.sections_product[1].id}
          >
          ...
          <LabelCont
            key={JSON.parse(singleProductData.data.description).details_data.sections_product[2].id}
          >
            ...
            (section: any, index: number) =>
              index >= 4 && (
                <LabelCont>
                  <LabelKey>
                    {
                      JSON.parse(singleProductData.data.description).details_data.sections_product[
                        index
                      ].label_key
                    }
                  </LabelKey>
