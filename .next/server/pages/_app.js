...
})(["position:fixed;width:383px;height:calc(100% - ", ");background-color:", ";box-shadow:", ";border-radius:20px;display:flex;flex-wrap:wrap;right:0px;z-index:980;"], HeaderHeight, ({
  theme
...
})(["display:flex;flex-wrap:wrap;width:100%;height:96%;"]);
...
})(["display:flex;flex-direction:column;height:350px;width:100%;box-sizing:border-box;overflow-y:scroll;"]);
...
})(["display:flex;background-color:green;margin-top:5px;"]);
...
})(["font-size:15px;width:100%;overflow:hidden;display:flex;flex-direction:column;align-self:flex-end;"]);
...
})(["font-size:15px;width:100%;overflow:hidden;display:flex;flex-direction:column;resize:none;"]);
...
})(["font-size:15px;width:100%;overflow:hidden;height:30px;display:flex;flex-direction:column;"]);
...
function CommentModal({}) {
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(TakeCommentsToSideMakeAbsolute, {
    children: [/*#__PURE__*/jsx_runtime_.jsx("button", {
      onClick: () => dontShowComments(),
      children: "X"
    }), commentsType.type !== null && /*#__PURE__*/(0,jsx_runtime_.jsxs)(CommentsTabStyle, {
      children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(CommentsTabMainNameStyle, {
        children: [commentsType.user.name, " "]
      }), /*#__PURE__*/jsx_runtime_.jsx(AllCommentsCont, {
        children: Comments.map(comment => /*#__PURE__*/jsx_runtime_.jsx(CommentStyle, {
