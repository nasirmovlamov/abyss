        ...
        <>
            <SearchForHome_STY.SearchBoxThunkAndCont_STY >
                <SearchForHome_STY.SearchBox_STY  
                    ...
                    > 
                    {router.asPath !=='/' &&  <SearchForHome_STY.SearchBoxPage_STY>{pagePath}</SearchForHome_STY.SearchBoxPage_STY>}
                    <SearchForHome_STY.SearchCont_STY path={router.asPath}>
                        <SearchForHome_STY.SearchButtonLupa_STY onClick={searchHandleWithSubmit}><FontAwesomeIcon  icon={faSearch}/></SearchForHome_STY.SearchButtonLupa_STY>
                        <SearchForHome_STY.SearchInput_STY onFocus={focusSearchHandle} onBlur={() => setboxFocused(false)}  path={router.asPath} onKeyDown={(e:any) => searchHandleWithEnter(e.keyCode)} value={searchQuery}  onChange={(e:any) => changeSearchValue(e.target.value)}   placeholder="Search..." ref={searchInputRef}   type="text" /> 
                        {router.asPath !=='/' && <SearchForHome_STY.SearchNav_STY  path={router.asPath} ref={searchNavRef}>
                            {/* <SearchNavQuery>
                    ...
                    {pagePath !== "Home" && <SearchForHome_STY.AddQuesitionCont_STY onClick={handleAddClick}>ADD</SearchForHome_STY.AddQuesitionCont_STY>}
                </SearchForHome_STY.SearchBox_STY>
