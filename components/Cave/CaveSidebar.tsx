...
const CaveSidebar = (props: Props) => {
    ...
    return (
        <CaveSidebar_Sty>
            <CaveSide_section_Sty shop={undefined} logout={undefined} selected={caveSideData.selectedWindow === "profile"}  onClick={() => selectWindow("profile")}> 
                <FontAwesomeIcon icon={faUser}/> 
                <span>Profile</span> 
            </CaveSide_section_Sty>
            
            <CaveSide_section_Sty shop={undefined} logout={undefined} selected={caveSideData.selectedWindow === "inventory"}  onClick={() => selectWindow("inventory")}>
                <FontAwesomeIcon icon={faBox}/> 
                <p> Inventory</p>
            </CaveSide_section_Sty>

            <CaveSide_section_Sty shop={undefined} logout={undefined} selected={caveSideData.selectedWindow === "library"}  onClick={() => selectWindow("library")}>
                <FontAwesomeIcon icon={faBookReader}/> 
                <p>Library</p> 
            </CaveSide_section_Sty>

            <CaveSide_section_Sty shop={undefined} logout={undefined}   selected={caveSideData.selectedWindow === "notes"}  onClick={() => selectWindow("notes")}>
                <FontAwesomeIcon icon={faStickyNote}/> 
                <p>Notes</p> 
            </CaveSide_section_Sty>

            <CaveSide_section_Sty shop={undefined} logout={undefined}    selected={caveSideData.selectedWindow === "guide"}  onClick={() => selectWindow("guide")}>
                <FontAwesomeIcon icon={faInfoCircle}/> 
                <p> Guide</p>
            </CaveSide_section_Sty>

            <CaveSide_section_Sty  logout={undefined} selected={caveSideData.selectedWindow === "shop"} shop={true}  onClick={() => selectWindow("shop")}>
