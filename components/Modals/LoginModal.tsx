    ...
    return (
        <ModalFORM_STY onSubmit={formSubmit}>
            <div style={{ display: 'flex', flexDirection: "column", alignItems: 'flex-end', marginTop: "0px", marginBottom: "10px" }}>
                <Form_STY.F_CloseButton_STY type="button" onClick={() => dispatch(changeModalAction('login'))} >
            ...
            <Form_STY.F_FlexerEnd_STY >
                <Form_STY.F_ForgetPass_STY type="button" onClick={() => dispatch(changeModalAction('forgetPassword'))}>Forget Password ? </Form_STY.F_ForgetPass_STY>
            </Form_STY.F_FlexerEnd_STY>
        </ModalFORM_STY>
    )
}
