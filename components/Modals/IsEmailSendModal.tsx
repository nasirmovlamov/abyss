    ...
    return (
            <ModalFORM_STY onSubmit={formSubmit}>
                ...
                </div>
                {
                    ...
                    <div style={{display:'flex',flexDirection:"column",alignItems:'center',marginTop:"20px",marginBottom:"10px"}}>
                        {
                            (userForgetPass && userForgetPass.errors) && 
                ...
                {userForgetPass.status  !== "pending" &&<p style={{color:userForgetPass.status  === "failed" ? "red" : "green", textAlign:"center"}}>{userForgetPass.message}</p>}
            </ModalFORM_STY>
    )
}
