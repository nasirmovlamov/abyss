    ...
    return (
        <PAGE_STY.TabsContainer_STY>
            <PAGE_STY.Tabs_STY>
                ...
                <PAGE_STY.TabButton_STY  onClick={() => selectType(searchTypes[0])} id="tab1" tabFocus={forumSort.includes(searchTypes[0])} name="tab" >
                ...
                <PAGE_STY.TabButton_STY onClick={() => selectType(searchTypes[1])} id="tab2" tabFocus={forumSort.includes(searchTypes[1])} name="tab" >
                ...
                <PAGE_STY.TabButton_STY onClick={() => selectType(searchTypes[2])} id="tab3" tabFocus={forumSort.includes(searchTypes[2])} name="tab" >
                    <PAGE_STY.TabText_STY  style={{}}>
                        {searchTypes[2]}
                    </PAGE_STY.TabText_STY> 
                    {/* <Line  />    */}
            ...
            <PAGE_STY.TabTagsAndResults_STY>
                ...
                <PAGE_STY.TabTagsCont_STY>
                    <PAGE_STY.TabTags_STY name="tag" tagFocus={forumType.includes(searchSorts[0])} onClick={() =>selectSort(searchSorts[0])}>{searchSorts[0]}</PAGE_STY.TabTags_STY>
                    <PAGE_STY.TabTags_STY name="tag" tagFocus={forumType.includes(searchSorts[1])} onClick={() => selectSort(searchSorts[1])}>{searchSorts[1]}</PAGE_STY.TabTags_STY>
                    <PAGE_STY.TabTags_STY name="tag" tagFocus={forumType.includes(searchSorts[2])} onClick={() => selectSort(searchSorts[2])}>{searchSorts[2]}</PAGE_STY.TabTags_STY>
                    <PAGE_STY.TabTags_STY name="tag" tagFocus={forumType.includes(searchSorts[3])} onClick={() => selectSort(searchSorts[3])}>{searchSorts[3]}</PAGE_STY.TabTags_STY>
                </PAGE_STY.TabTagsCont_STY>
            </PAGE_STY.TabTagsAndResults_STY>
